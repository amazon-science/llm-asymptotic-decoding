...
for input_file_name in input_file_arr:
    ...
    print('ppl ', ppl_llm_mean, cd_ppl_best_mean, ap_ppl_best_mean, ppl_hlm_mean, 100 * (cd_ppl_best_mean - ap_ppl_best_mean) / (ppl_llm_mean - ppl_hlm_mean), 100 * (ppl_llm_mean - ap_ppl_best_mean ) / (ppl_llm_mean - ppl_hlm_mean)  )
    print('mrr ', mrr_llm_mean, cd_mrr_best_mean, ap_mrr_best_mean, mrr_hlm_mean, 100 * (ap_mrr_best_mean - cd_mrr_best_mean) / (mrr_hlm_mean - mrr_llm_mean), 100 * (ap_mrr_best_mean - mrr_llm_mean  ) / (mrr_hlm_mean - mrr_llm_mean)  )
    ...
    if have_acc:
        ...
        print('acc ', acc_llm_mean, cd_acc_best_mean, ap_acc_best_mean, acc_hlm_mean, 100 * (ap_acc_best_mean - cd_acc_best_mean) / (acc_hlm_mean - acc_llm_mean), 100 * (ap_acc_best_mean - acc_llm_mean) / (acc_hlm_mean - acc_llm_mean))
