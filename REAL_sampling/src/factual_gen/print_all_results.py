...
#output_file = 'outputs/factual_gen/Pythia_test_last_{}.csv'.format(eval_name)
#output_file = 'outputs/factual_gen/Pythia_test_{}.csv'.format(eval_name)
#output_file = 'outputs/factual_gen/OPT_test_{}.csv'.format(eval_name)
#output_file = 'outputs/factual_gen/llama_test_{}.csv'.format(eval_name)
...
output_col = [
    ...
    'NE_ER_factual_std', 'Entail_factual_std', 'Repetition_factual_std', 
    'div_nonfactual_2', 'div_nonfactual_3', 'div_nonfactual_4', 
    'NE_ER_nonfactual', 'Entail_nonfactual', 'Repetition_nonfactual', 
    'NE_ER_nonfactual_std', 'Entail_nonfactual_std', 'Repetition_nonfactual_std', 
    ]

for result_dir in listdir(record_dir):
    if not result_dir.startswith(dataset_prefix+'6.9b_AP') and not result_dir.startswith(dataset_prefix+'6.9b_CS') and not result_dir.startswith(dataset_prefix+'6.9b_CD') and not result_dir.startswith(dataset_prefix+'6.9b_fe_AP_topp') and not result_dir.startswith(dataset_prefix+'6.9b_fe_CD_topp') and not result_dir.startswith(dataset_prefix+'6.9b_fe_top') and not result_dir.startswith(dataset_prefix+'6.9b_fecut_topp') and not result_dir.startswith(dataset_prefix+'6.9b_topp') and not result_dir.startswith(dataset_prefix+'6.9b_topk') and not result_dir.startswith(dataset_prefix+'6.9b_typical') and not result_dir.startswith(dataset_prefix+'6.9b_eta') and not result_dir.startswith(dataset_prefix+'6.9b_decay') and not result_dir.startswith(dataset_prefix+'6.9b_p') and not result_dir.startswith(dataset_prefix+'OpenLLaMA2-7b') and not result_dir.startswith(dataset_prefix+'OPT-6.7b') and not result_dir.startswith(dataset_prefix+'GPT2') and not (result_dir.startswith(dataset_prefix+'6.9b_DoLa')):
    #if not result_dir.startswith(dataset_prefix+'6.9b_AP') and not result_dir.startswith(dataset_prefix+'6.9b_CS') and not result_dir.startswith(dataset_prefix+'6.9b_CD') and not result_dir.startswith(dataset_prefix+'6.9b_fe_AP_topp') and not result_dir.startswith(dataset_prefix+'6.9b_fe_CD_topp') and not result_dir.startswith(dataset_prefix+'6.9b_fe_top') and not result_dir.startswith(dataset_prefix+'6.9b_fecut_topp') and not result_dir.startswith(dataset_prefix+'6.9b_topp') and not result_dir.startswith(dataset_prefix+'6.9b_topk') and not result_dir.startswith(dataset_prefix+'6.9b_typical') and not result_dir.startswith(dataset_prefix+'6.9b_eta') and not result_dir.startswith(dataset_prefix+'6.9b_decay') and not result_dir.startswith(dataset_prefix+'6.9b_p') and not result_dir.startswith(dataset_prefix+'OpenLLaMA2-7b') and not result_dir.startswith(dataset_prefix+'OPT-6.7b') and not result_dir.startswith(dataset_prefix+'GPT2') and not (result_dir.startswith(dataset_prefix+'6.9b_DoLa') and result_dir.endswith('_even')):
    #if not result_dir.startswith(dataset_prefix+'6.9b_AP') and not result_dir.startswith(dataset_prefix+'6.9b_CS') and not result_dir.startswith(dataset_prefix+'6.9b_CD') and not result_dir.startswith(dataset_prefix+'6.9b_fe_AP_topp') and not result_dir.startswith(dataset_prefix+'6.9b_fe_CD_topp') and not result_dir.startswith(dataset_prefix+'6.9b_fe_top') and not result_dir.startswith(dataset_prefix+'6.9b_fecut_topp') and not result_dir.startswith(dataset_prefix+'6.9b_topp') and not result_dir.startswith(dataset_prefix+'6.9b_topk') and not result_dir.startswith(dataset_prefix+'6.9b_typical') and not result_dir.startswith(dataset_prefix+'6.9b_eta') and not result_dir.startswith(dataset_prefix+'6.9b_decay') and not result_dir.startswith(dataset_prefix+'6.9b_p') and not (result_dir.startswith(dataset_prefix+'6.9b_DoLa')):
   # if not result_dir.startswith(dataset_prefix+'6.9b_AP') and not result_dir.startswith(dataset_prefix+'6.9b_CS') and not result_dir.startswith(dataset_prefix+'6.9b_CD') and not result_dir.startswith(dataset_prefix+'6.9b_fe_AP_topp') and not result_dir.startswith(dataset_prefix+'6.9b_fe_CD_topp') and not result_dir.startswith(dataset_prefix+'6.9b_fe_top') and not result_dir.startswith(dataset_prefix+'6.9b_fecut_topp') and not result_dir.startswith(dataset_prefix+'6.9b_topp') and not result_dir.startswith(dataset_prefix+'6.9b_topk') and not result_dir.startswith(dataset_prefix+'6.9b_typical') and not result_dir.startswith(dataset_prefix+'6.9b_eta') and not result_dir.startswith(dataset_prefix+'6.9b_decay') and not result_dir.startswith(dataset_prefix+'6.9b_p') and not (result_dir.startswith(dataset_prefix+'6.9b_DoLa') and result_dir.endswith('_even')):
    #if not result_dir.startswith(dataset_prefix+'OPT-6.7b'):
    #if not result_dir.startswith(dataset_prefix+'OpenLLaMA2-7b'):
        continue
    ...
    output_arr = [div_2, div_3, div_4, 
            ...
            np.std(NE_ER_factual_arr), np.std(Entail_factual_arr), np.std(Repetition_factual_arr), 
            ...
            np.std(NE_ER_nonfactual_arr), np.std(Entail_nonfactual_arr), np.std(Repetition_nonfactual_arr) ]
