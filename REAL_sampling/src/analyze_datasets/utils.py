...
def binary_eval(predy, testy, predy_pro, verbose=True, return_f1=False, predscore=None):
    ...
    average_precision = average_precision_score(testy, predy_pro)
    epsilon = 1e-8
    ...
    info = "Acc : {}\nf1 : {}\nprecision : {}\nrecall : {}\nG-mean : {}\nAP : {}".format(acc,
            ...
            " ".join([str(x) for x in recall]), gmean, average_precision)
