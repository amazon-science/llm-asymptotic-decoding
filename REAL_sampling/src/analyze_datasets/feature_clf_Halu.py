...
class ClfModel:
      ...
      def load_feature_file(self, f_in):
            X_pos, X_neg = json.load(f_in)
            X_pos = self.filter_features(X_pos)
            X_neg = self.filter_features(X_neg)
...
if __name__ == '__main__':
    ...
    parser.add_argument("--input_train_feature_name", default="/mnt/efs/Haw-Shiuan/true_entropy/outputs/Halu/features/summarization_data_1024_train_OWT_perOWT.json", type=str) 
    parser.add_argument("--input_val_feature_name", default="/mnt/efs/Haw-Shiuan/true_entropy/outputs/Halu/features/summarization_data_1024_val_OWT_perOWT.json", type=str) 
    #parser.add_argument("--input_train_feature_name", default="/mnt/efs/Haw-Shiuan/true_entropy/outputs/Halu/features/summarization_data_1024_train_wiki_smallOWT.json", type=str) 
    #parser.add_argument("--input_val_feature_name", default="/mnt/efs/Haw-Shiuan/true_entropy/outputs/Halu/features/summarization_data_1024_val_wiki_smallOWT.json", type=str) 
    ...
    #parser.add_argument("--input_train_feature_name", default="/mnt/efs/Haw-Shiuan/true_entropy/outputs/Halu/features/qa_data_train_OWT_perOWT.json", type=str) 
    #parser.add_argument("--input_val_feature_name", default="/mnt/efs/Haw-Shiuan/true_entropy/outputs/Halu/features/qa_data_val_OWT_perOWT.json", type=str) 
    #parser.add_argument("--input_train_feature_name", default="/mnt/efs/Haw-Shiuan/true_entropy/outputs/Halu/features/qa_data_train_wiki_smallOWT.json", type=str) 
    #parser.add_argument("--input_val_feature_name", default="/mnt/efs/Haw-Shiuan/true_entropy/outputs/Halu/features/qa_data_val_wiki_smallOWT.json", type=str) 
    #parser.add_argument("--input_train_feature_name", default="/mnt/efs/Haw-Shiuan/true_entropy/outputs/Halu/features/dialogue_data_knowledge_train_OWT_perOWT.json", type=str) 
    #parser.add_argument("--input_val_feature_name", default="/mnt/efs/Haw-Shiuan/true_entropy/outputs/Halu/features/dialogue_data_knowledge_val_OWT_perOWT.json", type=str) 
    #parser.add_argument("--input_train_feature_name", default="/mnt/efs/Haw-Shiuan/true_entropy/outputs/Halu/features/qa_data_knowledge_train_OWT_perOWT.json", type=str) 
    #parser.add_argument("--input_val_feature_name", default="/mnt/efs/Haw-Shiuan/true_entropy/outputs/Halu/features/qa_data_knowledge_val_OWT_perOWT.json", type=str) 
    
    #parser.add_argument("--output_score_name", default="/mnt/efs/Haw-Shiuan/true_entropy/outputs/Halu/scores/summarization_data_1024_wiki_small_lr.txt", type=str) 
    #parser.add_argument("--output_score_name", default="/mnt/efs/Haw-Shiuan/true_entropy/outputs/Halu/scores/summarization_data_1024_no_pred_lr.txt", type=str) 
    #parser.add_argument("--output_score_name", default="/mnt/efs/Haw-Shiuan/true_entropy/outputs/Halu/scores/summarization_data_1024_wiki_lr.txt", type=str) 
    #parser.add_argument("--output_score_name", default="/mnt/efs/Haw-Shiuan/true_entropy/outputs/Halu/scores/summarization_data_1024_smallOWT_lr.txt", type=str) 
    #parser.add_argument("--output_score_name", default="/mnt/efs/Haw-Shiuan/true_entropy/outputs/Halu/scores/summarization_data_1024_OWT_lr.txt", type=str) 
    parser.add_argument("--output_score_name", default="/mnt/efs/Haw-Shiuan/true_entropy/outputs/Halu/scores/summarization_data_1024_OWT_per_OWT_lr.txt", type=str) 
    ...
    #parser.add_argument("--output_score_name", default="/mnt/efs/Haw-Shiuan/true_entropy/outputs/Halu/scores/qa_data_RF5.txt", type=str) 
    #parser.add_argument("--output_score_name", default="/mnt/efs/Haw-Shiuan/true_entropy/outputs/Halu/scores/qa_data_lr.txt", type=str) 
    #parser.add_argument("--output_score_name", default="/mnt/efs/Haw-Shiuan/true_entropy/outputs/Halu/scores/qa_data_more_lr.txt", type=str) 
    #parser.add_argument("--output_score_name", default="/mnt/efs/Haw-Shiuan/true_entropy/outputs/Halu/scores/qa_data_more2_lr.txt", type=str) 
    #parser.add_argument("--output_score_name", default="/mnt/efs/Haw-Shiuan/true_entropy/outputs/Halu/scores/qa_data_more_OWT_lr.txt", type=str) 
    #parser.add_argument("--output_score_name", default="/mnt/efs/Haw-Shiuan/true_entropy/outputs/Halu/scores/qa_data_more_wiki_lr.txt", type=str) 
    #parser.add_argument("--output_score_name", default="/mnt/efs/Haw-Shiuan/true_entropy/outputs/Halu/scores/qa_data_more_smallOWT_lr.txt", type=str) 
    #parser.add_argument("--output_score_name", default="/mnt/efs/Haw-Shiuan/true_entropy/outputs/Halu/scores/qa_data_no_pred_lr.txt", type=str) 
    #parser.add_argument("--output_score_name", default="/mnt/efs/Haw-Shiuan/true_entropy/outputs/Halu/scores/dialogue_data_knowledge_RF5.txt", type=str) 
    #parser.add_argument("--output_score_name", default="/mnt/efs/Haw-Shiuan/true_entropy/outputs/Halu/scores/dialogue_data_knowledge_lr.txt", type=str) 
    #parser.add_argument("--output_score_name", default="/mnt/efs/Haw-Shiuan/true_entropy/outputs/Halu/scores/qa_data_knowledge_RF5.txt", type=str) 
    ...
    input_folder = '/mnt/efs/Haw-Shiuan/true_entropy/outputs/Halu/features/'
    output_folder = '/mnt/efs/Haw-Shiuan/true_entropy/outputs/Halu/scores/'
    log_folder = '/mnt/efs/Haw-Shiuan/true_entropy/log/Halu/'
    ...
    for dataset in datasets:
        for i, ent_model_name in enumerate(ent_model_names):
            ...
            for j in idx_range:
                ...
                #if feature_name != 'large_small_pred1' and feature_name != 'large_small_pred2':
                #    continue
